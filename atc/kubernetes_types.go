...
type ObjectMeta struct {
	...
	// +optional
	CreationTimestamp int64 `json:"creationTimestamp,omitempty" protobuf:"bytes,8,opt,name=creationTimestamp"`
	...
	// More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#metadata
	// +optional
	DeletionTimestamp *int64 `json:"deletionTimestamp,omitempty" protobuf:"bytes,9,opt,name=deletionTimestamp"`
...
type ManagedFieldsEntry struct {
	...
	// +optional
	Time *int64 `json:"time,omitempty" protobuf:"bytes,4,opt,name=time"`
...
type Condition struct {
	...
	LastTransitionTime int64 `json:"lastTransitionTime" protobuf:"bytes,4,opt,name=lastTransitionTime"`
